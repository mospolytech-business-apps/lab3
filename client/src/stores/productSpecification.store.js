...
export const useProductSpecificationsStore = defineStore(
  ...
  () => {
    ...
    const updateProductSpecification = async (productSpecification) => {
      const { res, err } = await api.updateProductSpecification(
    ...
    const addSpecification = async (specification) => {
      const { res, err } = await api.addProductSpecification(specification);
