...
- [ ] {Миша} 1.5 Инструменты - [Director] // Equipment.vue
...
- [ ] {Андрей 2} 3.1 Спецификации - [Master] // ProductSpecification.vue
...
- [ ] {Максим} 3.5 Отчет по ингридиентам - [Director, PurchaseManager] // IngredientsReport.vue

4 сессия:

- [x] {Артем} 4.1 Тесты на пароль
- [ ] {Максим} 4.2 Отчет по закупкам - [Director] // PurchaseReport.vue
- [ ] {Максим} 4.3 Отчет по сбоям - [Director] // EquipmentFailureReport.vue
